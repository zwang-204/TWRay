...
class hittable {
    public:
        ...
        virtual bool bounding_box(float time0, float time1, Bounds3f& output_box) const = 0;
...
bool translate::bounding_box(float time0, float time1, Bounds3f& output_box) const {
    // infinite recursion?
