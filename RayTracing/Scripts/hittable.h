...
class hittable {
    public:
        virtual bool hit(const Ray& r, float t_min, float t_max, SurfaceInteraction& si) const = 0;
...
bool translate::hit(const Ray& r, float t_min, float t_max, SurfaceInteraction& si) const {
...
bool rotate_y::hit(const Ray& r, float t_min, float t_max, SurfaceInteraction& si) const {
